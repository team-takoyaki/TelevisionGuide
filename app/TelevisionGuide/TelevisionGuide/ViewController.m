...
//    self.tableViewRecognizer = [self enableGestureTableViewWithDelegate:self];
//    UISwipeGestureRecognizer *swipeLeftGesture =
...
//    [_lm startUpdatingHeading];
    ...
    self.tableView.tableViewRecognizer = [self.tableView enableGestureTableViewWithDelegate:self.tableView];
